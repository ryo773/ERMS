                ...
                <div class="max-w-2xl mb-4 mx-auto">
                    ...
                    <form method="POST" action="{{ route('events.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="evnet_name" class="block mt-1 w-full" type="text" name="event_name" :value="old('event_name')" required autofocus />
                        </div>

                        <div class="mt-4">
                            <x-label for="information" value="イベント詳細" />
                            <x-textarea row="3" id="information" class="block mt-1 w-full" type="text" name="information" required >
                                {{ old('information') }}
                            </x-textarea>
                        </div>
